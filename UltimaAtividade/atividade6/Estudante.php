...
class Estudante {
    ...
    public function __toString() {
        return $this -> getNomeEstudante() . ", nascido em " . $this -> getDataNascimento() . ", com código de identificação " . $this -> getCodEstudante() . ", possui a nota final do Enem igual a " . $this -> getPontosEnem() . ".";
    }
}
